...
namespace p2pChat {
    ...
    /// </summary>
    /// <remarks>
    /// [c# - Is there a property/method for determining if a TcpListener is currently listening? - Stack Overflow](http://stackoverflow.com/questions/7630094)
    /// </remarks>
    public class TcpListenerEx :
        ...
        /// <exception cref="T:System.ArgumentOutOfRangeException"><paramref name="port"/> is not between <see cref="F:System.Net.IPEndPoint.MinPort"/> and <see cref="F:System.Net.IPEndPoint.MaxPort"/>. </exception>
